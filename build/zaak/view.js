...
/***/ "./node_modules/@gemeente-denhaag/process-steps/dist/index.css":
/*!*********************************************************************!*\
  !*** ./node_modules/@gemeente-denhaag/process-steps/dist/index.css ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@gemeente-denhaag/process-steps/dist/mjs/index.js":
/*!************************************************************************!*\
  !*** ./node_modules/@gemeente-denhaag/process-steps/dist/mjs/index.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
typeof SuppressedError === "function" ? SuppressedError : function (error, suppressed, message) {
    ...
    var className = _a.className, children = _a.children, _b = _a.current, current = _b === void 0 ? false : _b, _c = _a.appearance, appearance = _c === void 0 ? 'not-checked' : _c, props = __rest(_a, ["className", "children", "current", "appearance"]);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", __assign({}, props, { className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-process-steps__step', "denhaag-process-steps__step--".concat(appearance), className), "aria-current": current ? 'step' : undefined }), children));
};var StepList = function (_a) {
    var className = _a.className, _b = _a.nested, nested = _b === void 0 ? false : _b, children = _a.children, props = __rest(_a, ["className", "nested", "children"]);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ol", __assign({}, props, { className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-process-steps', nested && 'denhaag-process-steps--nested', className) }), children));
};var StepHeader = function (_a) {
    var children = _a.children, className = _a.className, nested = _a.nested, props = __rest(_a, ["children", "className", "nested"]);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", __assign({ className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-process-steps__step-header', { 'denhaag-process-steps__step-header--nested': nested }, className) }, props), children));
};var StepHeading = function (_a) {
    var children = _a.children, _b = _a.appearance, appearance = _b === void 0 ? 'not-checked' : _b, props = __rest(_a, ["children", "appearance"]);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", __assign({}, props, { className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-process-steps__step-heading', "denhaag-process-steps__step-heading--".concat(appearance)) }), children));
};var SubStep = function (_a) {
    var children = _a.children, _b = _a.appearance, appearance = _b === void 0 ? 'not-checked' : _b;
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-process-steps__sub-step', "denhaag-process-steps__sub-step--".concat(appearance)) }, children));
};var SubStepHeading = function (_a) {
    var children = _a.children;
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: 'denhaag-process-steps__sub-step-heading' }, children));
};var StepBody = function (_a) {
    var children = _a.children;
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-process-steps__step-body') }, children);
};var StepMeta = function (_a) {
    var date = _a.date, nested = _a.nested, children = _a.children;
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-process-steps__step-meta', date && 'denhaag-process-steps__step-meta--date', nested && 'denhaag-process-steps__step-meta--nested') }, children));
};var StepDetails = function (_a) {
    var id = _a.id, className = _a.className, _b = _a.collapsed, collapsed = _b === void 0 ? false : _b, children = _a.children;
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: id, className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-process-steps__step-details', collapsed && 'denhaag-process-steps__step-details--hidden', className) }, children));
};var StepHeaderToggle = function (_a) {
    var children = _a.children, className = _a.className, ariaControls = _a.ariaControls, expanded = _a.expanded, onClick = _a.onClick, props = __rest(_a, ["children", "className", "ariaControls", "expanded", "onClick"]);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", __assign({ "aria-controls": ariaControls, className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('utrecht-button', 'utrecht-button--subtle', 'denhaag-process-steps__step-header-toggle', className), onClick: onClick }, props),
        children,
        expanded ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gemeente_denhaag_icons__WEBPACK_IMPORTED_MODULE_2__.ChevronUpIcon, { className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-process-steps__step-header-toggle-icon') })) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gemeente_denhaag_icons__WEBPACK_IMPORTED_MODULE_2__.ChevronDownIcon, { className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-process-steps__step-header-toggle-icon') }))));
};var getLineAppearance = function (_a) {
    var _b = _a.stepStatus, stepStatus = _b === void 0 ? 'not-checked' : _b, _c = _a.nextStepStatus, nextStepStatus = _c === void 0 ? 'not-checked' : _c;
...
var canExpand = function (step) { var _a; return !!((_a = step.steps) === null || _a === void 0 ? void 0 : _a.length); };
var StatusStep = function (_a) {
    var _b, _c, _d, _e;
    var step = _a.step, nextStep = _a.nextStep, _f = _a.expanded, expanded = _f === void 0 ? true : _f, toggleExpanded = _a.toggleExpanded;
    var nextStatus = (expanded && ((_c = (_b = step.steps) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.status)) || (nextStep === null || nextStep === void 0 ? void 0 : nextStep.status);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Step, { appearance: step.status, current: step.status === 'current' },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepHeader, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gemeente_denhaag_step_marker__WEBPACK_IMPORTED_MODULE_3__.StepMarker, { appearance: step.status }, step.status === 'checked' ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gemeente_denhaag_icons__WEBPACK_IMPORTED_MODULE_2__.CheckedIcon, null)) : step.status === 'warning' ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gemeente_denhaag_icons__WEBPACK_IMPORTED_MODULE_2__.AlertTriangleIcon, null)) : step.status === 'error' ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gemeente_denhaag_icons__WEBPACK_IMPORTED_MODULE_2__.CloseIcon, null)) : (step.marker)),
            toggleExpanded && canExpand(step) ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepHeaderToggle, { ariaControls: "".concat(step.id, "--details"), expanded: expanded, onClick: toggleExpanded },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepHeading, { appearance: step.status }, step.title))) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepHeading, { appearance: step.status }, step.title))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepBody, null,
            nextStep && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gemeente_denhaag_step_marker__WEBPACK_IMPORTED_MODULE_3__.StepMarkerConnector, { from: "main", to: expanded ? 'nested' : 'main', appearance: getLineAppearance({
                    stepStatus: step.status,
                    nextStepStatus: nextStatus,
                }) })),
            step.meta && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepMeta, null, step.meta),
            step.date && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepMeta, { date: true }, step.date)),
        Boolean((_d = step.steps) === null || _d === void 0 ? void 0 : _d.length) && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepDetails, { id: "".concat(step.id, "--details"), collapsed: !expanded },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepList, null, (_e = step.steps) === null || _e === void 0 ? void 0 : _e.map(function (substep, index, substeps) {
                var nextSubStep = substeps[index + 1];
                var nextStatus = (nextSubStep === null || nextSubStep === void 0 ? void 0 : nextSubStep.status) || (nextStep === null || nextStep === void 0 ? void 0 : nextStep.status);
                return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(SubStep, { key: index },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepHeader, { nested: true },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gemeente_denhaag_step_marker__WEBPACK_IMPORTED_MODULE_3__.StepMarker, { appearance: substep.status, nested: true }, substep.status === 'checked' && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gemeente_denhaag_icons__WEBPACK_IMPORTED_MODULE_2__.CheckedIcon, null)),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(SubStepHeading, null, substep.title)),
                    (nextSubStep || nextStep) && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_gemeente_denhaag_step_marker__WEBPACK_IMPORTED_MODULE_3__.StepMarkerConnector, { from: "nested", to: nextSubStep ? 'nested' : 'main', appearance: getLineAppearance({
                            stepStatus: substep.status,
                            nextStepStatus: nextStatus,
                        }) })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepMeta, { nested: true }, substep.date)));
            }))))));
};
var toggleState = function (key, collection, setCollection) {
    if (collection.includes(key)) {
        setCollection(collection.filter(function (item) { return item !== key; }));
    }
    else {
        setCollection(__spreadArray(__spreadArray([], collection, true), [key], false));
    }
};
var Status = function (_a) {
    var _b = _a.steps, steps = _b === void 0 ? [] : _b, _c = _a.expandedSteps, initialExpanded = _c === void 0 ? [] : _c, _d = _a.disabledSteps, disabledSteps = _d === void 0 ? [] : _d, _e = _a.collapsible, collapsible = _e === void 0 ? false : _e;
    var _f = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(initialExpanded), expandedSteps = _f[0], setExpandedSteps = _f[1];
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StepList, null, steps.map(function (step, index) {
        var collapsibleStep = collapsible && step.collapsible !== false;
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StatusStep, { key: step.id, step: step, expanded: collapsibleStep ? expandedSteps.includes(step.id) : true, disabled: disabledSteps.includes(step.id), nextStep: steps[index + 1], toggleExpanded: collapsibleStep &&
                (function () {
...
/***/ "./node_modules/@gemeente-denhaag/process-steps/node_modules/@gemeente-denhaag/icons/dist/mjs/index.js":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/@gemeente-denhaag/process-steps/node_modules/@gemeente-denhaag/icons/dist/mjs/index.js ***!
  \*************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@gemeente-denhaag/step-marker/dist/mjs/index.js":
/*!**********************************************************************!*\
  !*** ./node_modules/@gemeente-denhaag/step-marker/dist/mjs/index.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
typeof SuppressedError === "function" ? SuppressedError : function (error, suppressed, message) {
    var e = new Error(message);
    return e.name = "SuppressedError", e.error = error, e.suppressed = suppressed, e;
};var StepMarkerConnector = function (_a) {
    var className = _a.className, _b = _a.appearance, appearance = _b === void 0 ? 'not-checked' : _b, from = _a.from, to = _a.to, props = __rest(_a, ["className", "appearance", "from", "to"]);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", __assign({}, props, { className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-step-marker__connector', "denhaag-step-marker__connector--".concat(appearance), "denhaag-step-marker__connector--".concat(from, "-to-").concat(to), className) })));
};var StepMarker = function (_a) {
    var children = _a.children, _b = _a.appearance, appearance = _b === void 0 ? 'not-checked' : _b, nested = _a.nested, props = __rest(_a, ["children", "appearance", "nested"]);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", __assign({}, props, { className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])('denhaag-step-marker', "denhaag-step-marker--".concat(appearance), nested && 'denhaag-step-marker--nested') }), children));
};//# sourceMappingURL=index.js.map
...
/***/ "./resources/blocks/zaak/components/Status.js":
/*!****************************************************!*\
  !*** ./resources/blocks/zaak/components/Status.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   Status: () => (/* binding */ Status)
/* harmony export */ });
/* harmony import */ var _gemeente_denhaag_process_steps__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gemeente-denhaag/process-steps */ "./node_modules/@gemeente-denhaag/process-steps/dist/mjs/index.js");
/* harmony import */ var _gemeente_denhaag_process_steps_index_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gemeente-denhaag/process-steps/index.css */ "./node_modules/@gemeente-denhaag/process-steps/dist/index.css");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__);



const Status = props => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_gemeente_denhaag_process_steps__WEBPACK_IMPORTED_MODULE_0__.Status, {
  ...props
});
...
/* harmony import */ var _components_Status__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Status */ "./resources/blocks/zaak/components/Status.js");
...
const components = {
  ...
  '.js-nlds-denhaag-status-component': _components_Status__WEBPACK_IMPORTED_MODULE_4__.Status
};
document.addEventListener('DOMContentLoaded', () => {
  Object.entries(components).forEach(([selector, Component]) => {
    ...
    elements.forEach(el => {
      ...
      root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(Component, {
        ...props
      }));
    });
  });
